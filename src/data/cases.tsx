    ...
    childs: [
      {
        ...
        desc:
          ...
          "Сложные интеграции с Bitrix24, Битрикс Управление Сайтом (БУС), а также с cервисом доставки DPD.\n" +
          "Реализация онлайн оплаты с использованием экваренга от СберБанка.\n" +
          "Разработка кастомных решений по принципу микросервисной архитектуру.",
        stack: [
          "Laravel (PHP)",
          "React.js (JavaScript)",
          "Django (Python)",
...

      {
        ...
        desc:
          ...
          "Формирование и согласование ТЗ в процессе реализации, многожественные изменения cценария и архитектуре.\n" +
          "Интеграция с СМС шлюзом, массовые E-mail рассылки, управление DNS, ежедневные бекапы и выгрузка лидов.\n" +
          "Разработка кастомных решений по принципу микросервисной архитектуру.",
...

      {
        title: (
          <span>
            ...
            по&nbsp;автоматизации складскийх помещений
          </span>
        ),
...

      {
        title: (
          <span>
            <strong>Lighthause</strong>&nbsp;&mdash; Сайт инфестиционного фонда
            для клиентов
          </span>
        ),
        desc:
